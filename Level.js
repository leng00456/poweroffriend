...
Level.prototype.create = function() {
	...
	this.scoreText = this.add.text(this.game.camera.width/2.5, 0, 'Star : '+this.game.score,{ font: '50px Arial',fill: 'white' });
...
Level.prototype.addScoreText = function(enemies) {
    ...
    delay.onComplete.add(function(addScore) {
        addScore.kill();
        this.game.time.events.duration=this.game.time.events.duration*10;
    }, this);
...
Level.prototype.die= function(player,enemies2){ 
	this.musicgame.stop();
